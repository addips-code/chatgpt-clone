        ...
        <div className='flex space-x-2 text-center'>
            <div>
                ...
                <div className="space-y-2">
                    <p className="infoText cursor-pointer">"Explain quantum computing in simple terms"ƒ</p>
                    <p className="infoText cursor-pointer">"Got any creative ideas for a 10 year old's birthday?"</p>
                    <p className="infoText cursor-pointer">"How do i make an HTTP request in Javascript?"</p>
                </div>
            </div>
